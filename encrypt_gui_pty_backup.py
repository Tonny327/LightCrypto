#!/usr/bin/env python3
"""
LightCrypto GUI - Интерфейс шифрования
Запускает tap_encrypt в неймспейсе ns1
"""
...
class EncryptGUI:
    ...
    def setup_gui(self):
        ...
        # IP адрес
        ip_label = tk.Label(input_frame, text="Введите IP. По умолчанию 127.0.0.1")
        ...
        self.message_check = tk.Checkbutton(
            input_frame,
            text="☐ Режим передачи текстовых сообщений",
    ...
    def start_process(self):
        ...
        if not os.path.exists("./build/tap_encrypt"):
            self.console_text.insert(tk.END, "❌ Файл ./build/tap_encrypt не найден\n")
